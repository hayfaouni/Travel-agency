                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="tours-item">
                                <div class="tours-image">
                                    <a href="#">
                                        <img class="imghotel" src="../../entities/img/<?PHP echo $row['image']; ?>">
                                    </a>
                                </div>
                                ...
                                <div class="tours-content">
                                    <ul class="tours-list">
                                        ...
                                        <li>
                                           ...
                                           Lieu depart: <?PHP echo $row['lieu_aller']; ?>
                                            </i>
                                        </li>
                                        <li>
                                            <i class="fa fa-map-marker">
                                             Lieu arrivee:   <?PHP echo $row['lieu_retour']; ?>
                                            </i>
                                        </li>
                                        <br>
                                        <li>
                                            <i class="fa fa-calendar-alt">
                                              date aller  <?PHP echo $row['date_aller']; ?>
                                            </i>
                                        </li>
                                    
                                            <li>
                                            <i class="fa fa-calendar-alt">
                                                date retour<?PHP echo $row['date_retour']; ?>
                                            </i>
                                        </li>
                                    ...
                                    <h3>
                                        <a href="#">
                                          Nom Hotel:  <?PHP echo $row['nom_hotel']; ?></a>
                                    </h3>
